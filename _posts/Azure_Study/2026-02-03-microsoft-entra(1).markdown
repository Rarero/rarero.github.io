...
![entraid icon change](/images/Azure_Study/2026-02-03-microsoft-entra(1)/26-02-03-microsoft-entra(1)-change_icon.png)
...
- 사용자 ID, 디바이스 상태, 위치 등 다차원 컨텍스트 기반 액세스 결정
...
![external id](/images/Azure_Study/2026-02-03-microsoft-entra(1)/26-02-03-microsoft-entra(1)-external_id.png)
...
![did system](/images/Azure_Study/2026-02-03-microsoft-entra(1)/26-02-03-microsoft-entra(1)-did_system.png)
